<?php
        ...
        // echo $_POST['answer_fee1'];
        // echo $_POST['answer_fee2'];
        // echo exit;
        ...
        // if(isset($_POST['submit'])){
                 ...
                 */
                $total1 = $_POST['answer_fee1']+$_POST['answer_fee2']+$_POST['answer_fee3']+$_POST['answer_fee4']+$_POST['answer_fee5']+$_POST['answer_fee6']+$_POST['answer_fee7']+$_POST['answer_fee8']+$_POST['answer_fee9']+$_POST['answer_fee10'];
                $total2 = $_POST['answer_fee11']+$_POST['answer_fee12']+
                $_POST['answer_fee13']+
                $_POST['answer_fee14']+
                $_POST['answer_fee15']+
                $_POST['answer_fee16']+
